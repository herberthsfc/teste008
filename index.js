...
case 'lofi':
          ...
          break
          case 'botcorno':
          if (args.length < 1) return reply('Um homem sem chifres, é um animal indefeso!','Se você não sabia, fique esperto, o corno é sempre o ultimo a saber!','É melhor ser corno, do que nunca ter chegado perto de uma vaca!','Chifre não existe, isso é coisa que botam na sua cabeça!')
          break
          case 'eu sou':
          if (args.length < 1) return reply('Linda','Vadia','Gostosa','Corno','Fdp','Muito gostosa','Dahora','Zero defeitos','Legal','Pinto pequeno','Inteligente','Cuzao','Santista','Flamenguista','Medrosa')
          break
          case 'siri':
					hobby = body.slice(1)
